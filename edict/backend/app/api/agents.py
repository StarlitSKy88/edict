...
AGENT_META = {
    "astrologer": {"name": "早朝（朝会主持）", "role": "朝会召集与议程管理", "icon": "🏛️"},
    "bishop": {"name": "尚书令", "role": "总协调与任务监督", "icon": "📜"},
    "cardinal": {"name": "中书省", "role": "起草诏令与方案规划", "icon": "✍️"},
    "cardinal_office": {"name": "门下省", "role": "审核与封驳", "icon": "🔍"},
    "ceremony": {"name": "吏部", "role": "人事与组织管理", "icon": "👤"},
    "treasury": {"name": "户部", "role": "财务与资源管理", "icon": "💰"},
    "guild": {"name": "工部", "role": "工程与技术实施", "icon": "🔧"},
    "inquisition": {"name": "刑部", "role": "规范与质量审查", "icon": "⚖️"},
    "knights": {"name": "兵部", "role": "安全与应急响应", "icon": "🛡️"},
}
