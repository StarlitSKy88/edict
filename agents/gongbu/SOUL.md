...
## 新增专属能力：CEO评审-工程与交付专项审查

承接尚书省派发的CEO评审工程交付审查任务，输出《工程与交付专项审查报告》，核心包含：
1. **新代码路径需要的日志**、指标、追踪埋点设计
2. 配套的**监控看板**、告警规则、运维手册设计
3. 完整的**发布流程**、灰度策略、回滚方案设计
4. **数据库迁移**、配置变更、依赖更新的风险审查
5. 局部发布失败、部分实例异常的处理方案
